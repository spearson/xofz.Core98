namespace xofz.Tests.Framework.Log
{
    ...
    public class DateRangeChangedHandlerTests
    {
        public class Context
        {
            protected Context()
            {
                ...
                this.handler = new DateRangeChangedHandler(
                    this.web);
            ...
            protected readonly DateRangeChangedHandler handler;
        ...
        public class When_Handle_is_called : Context
        {
            ...
            [Fact]
            public void Otherwise_sets_refreshOnStartIf1_to_1()
            {
